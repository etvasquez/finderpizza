...
public class BasesPanel extends JPanel implements Selectable {
    ...
    public BasesPanel(PizzaOntology ontology) {
    ...
    protected JTree buildTree()  {
        MutableTreeNode rootNode = new DefaultMutableTreeNode("Bases");
        for (OWLClassExpression owlClassExpression : ontology.getPizzaBaseCategories()) {
        ...
        t.setCellRenderer(new BasesPanel.OWLClassTreeCellRenderer());
        return t;
    }
    ...
    public static void main(String [] args) {
        BasesPanel panel = new BasesPanel(new PizzaOntology());
        JFrame frm = new JFrame();
        frm.setSize(300, 400);
        frm.getContentPane().setLayout(new BorderLayout());
        frm.getContentPane().add(panel);
        frm.getContentPane().add(new JLabel("Bases!"), BorderLayout.NORTH);
    ...
    public class OWLClassTreeCellRenderer extends DefaultTreeCellRenderer {
        ...
        public Component getTreeCellRendererComponent(JTree tree,
            ...
            if(obj instanceof OWLClass) {
                label.setText(ontology.render1(((OWLClass) obj)));
            }
            else {
